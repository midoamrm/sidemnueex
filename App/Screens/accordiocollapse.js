...
import Accordian from './Accordioncompent'
  ...
  constructor(props) {
    ...
    this.state = {
      menu :[
        ...
        { 
          title: 'Pizzas',
          data: [{key: 'Chicken Dominator', value: false},
        ...
        { 
         title: 'Drinks',
         data: [{key: 'Cocktail', value:false},
         {key: 'Mocktail', value:false},
         {key: 'Lemon Soda', value:false},
         {ey: 'Orange Soda', value: false}]
        },
        { 
          title: 'Deserts',
          data: [{key: 'Choco Lava Cake', value:false},
